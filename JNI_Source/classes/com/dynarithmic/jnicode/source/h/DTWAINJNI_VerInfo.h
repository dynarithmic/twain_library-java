...
#define DTWAINJNI_VERINFO_LEGALCOPYRIGHT       "Copyright © 2020-2026\0"
...
#define DTWAINJNI_NUMERIC_FILE_VERSION         DTWAINJNI_MAJOR_VERSION,DTWAINJNI_SUBVERSION_VERSION,DTWAINJNI_PLACEHOLDER_VERSION,DTWAINJNI_BUILDNUMBER_VERSION
