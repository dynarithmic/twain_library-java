...
(JNIEnv *env, jobject, jstring dllToLoad, jstring resPath)
{
    ...
    if ( !g_JNIGlobals.g_DTWAINModule )
    {
        ...
        if (g_JNIGlobals.g_DTWAINModule)
        {
            g_JNIGlobals.InitializeDSMCallerMap(JavaFunctionNameMapInstance::getFunctionMap()["LowLevelDirectory"].m_className);
        }
    }
...
{
    DO_DTWAIN_TRY
    return API_INSTANCE DTWAIN_IsPatchcodeCapsSupported(reinterpret_cast<DTWAIN_SOURCE>(src))?JNI_TRUE:JNI_FALSE;
    DO_DTWAIN_CATCH(env)
}
...
{
    DO_DTWAIN_TRY
    return API_INSTANCE DTWAIN_IsPatchcodeDetectionEnabled(reinterpret_cast<DTWAIN_SOURCE>(src))?JNI_TRUE:JNI_FALSE;
    DO_DTWAIN_CATCH(env)
}
...
(JNIEnv *env, jobject, jlong src)
{
    ...
    DTWAIN_ARRAY arr = nullptr;
    DTWAINArrayPtr_RAII raii(&arr);
    return CallFnReturnArray<JavaIntArrayTraits>(env, &arr, API_INSTANCE DTWAIN_EnumPatchcodeMaxRetries, reinterpret_cast<DTWAIN_SOURCE>(src), &arr);
    DO_DTWAIN_CATCH(env)
}
...
(JNIEnv *env, jobject, jlong src)
{
    ...
    DTWAIN_ARRAY arr = nullptr;
    DTWAINArrayPtr_RAII raii(&arr);
    return CallFnReturnArray<JavaIntArrayTraits>(env, &arr, API_INSTANCE DTWAIN_EnumPatchcodeMaxPriorities, reinterpret_cast<DTWAIN_SOURCE>(src), &arr);
    DO_DTWAIN_CATCH(env)
}
...
(JNIEnv *env, jobject, jlong src)
{
    ...
    DTWAIN_ARRAY arr = nullptr;
    DTWAINArrayPtr_RAII raii(&arr);
    return CallFnReturnArray<JavaIntArrayTraits>(env, &arr, API_INSTANCE DTWAIN_EnumPatchcodeSearchModes, reinterpret_cast<DTWAIN_SOURCE>(src), &arr);
    DO_DTWAIN_CATCH(env)
}
...
(JNIEnv *env, jobject, jlong src)
{
    ...
    DTWAIN_ARRAY arr = nullptr;
    DTWAINArrayPtr_RAII raii(&arr);
    return CallFnReturnArray<JavaIntArrayTraits>(env, &arr, API_INSTANCE DTWAIN_EnumPatchcodeTimeOutValues, reinterpret_cast<DTWAIN_SOURCE>(src), &arr);
    DO_DTWAIN_CATCH(env)
}
...
(JNIEnv *env, jobject, jlong src)
{
    ...
    DTWAIN_ARRAY arr = nullptr;
    DTWAINArrayPtr_RAII raii(&arr);
    return CallFnReturnArray<JavaIntArrayTraits>(env, &arr, API_INSTANCE DTWAIN_GetPatchcodePriorities, reinterpret_cast<DTWAIN_SOURCE>(src), &arr);
    DO_DTWAIN_CATCH(env)
}
...
(JNIEnv *env, jobject, jlong src)
{
    ...
    DTWAIN_ARRAY arr = nullptr;
    DTWAINArrayPtr_RAII raii(&arr);
    return CallFnReturnArray<JavaIntArrayTraits>(env, &arr, API_INSTANCE DTWAIN_EnumPatchcodePriorities, reinterpret_cast<DTWAIN_SOURCE>(src), &arr);
    DO_DTWAIN_CATCH(env)
}
...
/*    DTWAIN_ARRAY arr = nullptr;
    DTWAINArrayPtr_RAII raii(&arr);*/
    return CallFnReturnArray2<JavaStringTraits>(env, API_INSTANCE DTWAIN_EnumCamerasEx2, reinterpret_cast<DTWAIN_SOURCE>(src), whichCamera);
    DO_DTWAIN_CATCH(env)
}
  ...
  (JNIEnv* env, jobject, jlong arg1, jint arg2, jobject arg3)
{
    ...
    if ( dSetArray && dReturnArray )
    {
        ...
        API_INSTANCE DTWAIN_SetSourceUnit(reinterpret_cast<DTWAIN_SOURCE>(arg1), srcUnit);
  ...
  (JNIEnv *env, jobject, jlong src)
{
    ...
    if ( h && actualSize > 0 )
    {
        ...
        return CreateJArrayFromCArray<JavaByteArrayTraits<char> >(env, (JavaByteArrayTraits<char>::api_base_type*)&vBytes[0], static_cast<unsigned long>(vBytes.size()));
    }
    BYTE b;
  ...
  (JNIEnv *env, jobject, jlong src, jbyteArray customData)
{
    ...
    if ( dArray.empty() )
        return 1;
    return API_INSTANCE DTWAIN_SetCustomDSData(reinterpret_cast<DTWAIN_SOURCE>(src), nullptr, (LPBYTE)&dArray[0], static_cast<LONG>(dArray.size()), DTWAINSCD_USEDATA);
    DO_DTWAIN_CATCH(env)
}
      ...
      jint pixeltype, jint numpages, jboolean showUI, jboolean closeSource)
{
    ...
    DTWAINArray_RAII raii(dArray);
    API_INSTANCE DTWAIN_AcquireFileEx(reinterpret_cast<DTWAIN_SOURCE>(src), dArray, filetype, fileflags, pixeltype, numpages, showUI, closeSource, &nStatus);
    return nStatus;
    DO_DTWAIN_CATCH(env)
}
  ...
  (JNIEnv *env, jobject, jlong ocr, jint pageNum)
{
    ...
    if (hReturn)
    {
        ...
        API_INSTANCE DTWAIN_GetOCRText(reinterpret_cast<DTWAIN_OCRENGINE>(ocr), pageNum, &ts[0], static_cast<LONG>(ts.size()), &actualSize, DTWAINOCR_COPYDATA);
        return CreateJArrayFromCArray<JavaByteArrayTraits<TCHAR> >(env, &ts[0], static_cast<LONG>(ts.size())*sizeof(TCHAR));
    }
...
static TW_IMAGEMEMXFER GetBufferedMemXFerData(DTWAIN_SOURCE source)
{
    ...
    memxferInfo.BytesPerRow = allVals[1];
    memxferInfo.Columns = allVals[2];
    memxferInfo.Rows = allVals[3];
    memxferInfo.XOffset = allVals[4];
    memxferInfo.YOffset = allVals[5];
    memxferInfo.BytesWritten = allVals[6];
    memxferInfo.Memory.Flags = allVals[7];
    memxferInfo.Memory.Length = allVals[8];
...
(JNIEnv *env, jobject)
{
    ...
    if (retLength > 0)
    {
        ...
        API_INSTANCE DTWAIN_GetLibraryPath(arg.data(), static_cast<LONG>(arg.size()));
...
(JNIEnv *env, jobject)
{
    ...
    {
        std::vector<TCHAR> arg(retLength + 1);
        API_INSTANCE DTWAIN_GetVersionString(arg.data(), static_cast<LONG>(arg.size()));
        return CreateJStringFromCString(env, arg.data());
    }
...
(JNIEnv *env, jobject)
{
    ...
    {
        std::vector<TCHAR> arg(retLength + 1);
        API_INSTANCE DTWAIN_GetShortVersionString(arg.data(), static_cast<LONG>(arg.size()));
        return CreateJStringFromCString(env, arg.data());
    }
    TCHAR szNothing[] = { 0 };
    return CreateJStringFromCString(env, szNothing);
...
(JNIEnv *env, jobject)
{
    ...
    API_INSTANCE DTWAIN_GetTwainAppIDEx(&twIdentity);
...
(JNIEnv *env, jobject, jlong theSource)
{
    ...
    TW_IDENTITY twIdentity = {};
    DO_DTWAIN_CHECK_MODULE_LOAD
    API_INSTANCE DTWAIN_GetSourceIDEx(reinterpret_cast<DTWAIN_SOURCE>(theSource), &twIdentity);
    JavaDTwainLowLevel_TW_IDENTITY testClass(env);
...
static std::array<std::string, 3> GetTripletNames(TW_UINT32 DG, TW_UINT16 DAT, TW_UINT16 TMSG)
{
    ...
    API_INSTANCE DTWAIN_GetTwainNameFromConstantA(DTWAIN_DGNAME, DG, twainName, 1023);
    sTwainNames[0] = twainName;
    API_INSTANCE DTWAIN_GetTwainNameFromConstantA(DTWAIN_DATNAME, DAT, twainName, 1023);
    sTwainNames[1] = twainName;
    API_INSTANCE DTWAIN_GetTwainNameFromConstantA(DTWAIN_MSGNAME, TMSG, twainName, 1023);
...
(JNIEnv *env, jobject, jint category, jint twainID)
{
    ...
    LONG nLen = API_INSTANCE DTWAIN_GetTwainNameFromConstant(category, twainID, nullptr, 0);
    if (nLen >= 0)
    {
        name.resize((std::max)(static_cast<int>(nLen),1));
        API_INSTANCE DTWAIN_GetTwainNameFromConstant(category, twainID, name.data(), static_cast<LONG>(name.size()));
...
(JNIEnv *env, jobject)
{
    ...
    {
        name.resize((std::max)(static_cast<int>(nLen), 1));
        API_INSTANCE DTWAIN_GetActiveDSMPath(name.data(), static_cast<LONG>(name.size()));
        return static_cast<jstring>(CreateJStringFromCString(env, name.data()));
    }
    DO_DTWAIN_CATCH(env)
}
...
(JNIEnv* env, jobject)
{
    ...
    {
        std::vector<TCHAR> arg(retLength + 1);
        API_INSTANCE DTWAIN_GetVersionCopyright(arg.data(), static_cast<LONG>(arg.size()));
        return CreateJStringFromCString(env, arg.data());
    }
    TCHAR szNothing[] = { 0 };
    return CreateJStringFromCString(env, szNothing);
...
(JNIEnv* env, jobject, jint indentValue, jboolean bRefresh)
{
    ...
    {
        std::vector<TCHAR> arg(retLength + 1);
        API_INSTANCE DTWAIN_GetSessionDetails(arg.data(), static_cast<LONG>(arg.size()), indentValue, FALSE);
        return CreateJStringFromCString(env, arg.data());
    }
    TCHAR szNothing[] = { 0 };
    return CreateJStringFromCString(env, szNothing);
...
(JNIEnv* env, jobject, jstring sourceNames, jint indentValue, jboolean bRefresh)
{
    ...
    LONG retLength = API_INSTANCE DTWAIN_GetSourceDetails(reinterpret_cast<LPCTSTR>(str.GetStringChars()), vChars.data(), static_cast<LONG>(vChars.size()), indentValue, bRefresh);
    if (retLength > 0)
