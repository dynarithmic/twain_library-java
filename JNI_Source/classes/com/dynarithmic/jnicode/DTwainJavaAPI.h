 ...
 * Class:     com_dynarithmic_twain_DTwainJavaAPI
    ...
    * Signature: (JII)[Lcom/dynarithmic/twain/highlevel/TwainFrameDouble;
    */
 ...
 * Signature: (J)Lcom/dynarithmic/twain/highlevel/TwainImageInfo;
    */
    ...
    /*
    * Class:     com_dynarithmic_twain_DTwainJavaAPI
 * Method:    DTWAIN_GetAcquiredTileInfo
 * Signature: (J)Lcom/dynarithmic/twain/highlevel/BufferedTileInfo;
 */
JNIEXPORT jobject JNICALL Java_com_dynarithmic_twain_DTwainJavaAPI_DTWAIN_1GetAcquiredTileInfo
  (JNIEnv *, jobject, jlong);
 ...
 * Signature: (J)Lcom/dynarithmic/twain/highlevel/TwainSourceInfo;
    */
 ...
 * Class:     com_dynarithmic_twain_DTwainJavaAPI
    ...
    */
    ...
    (JNIEnv *, jobject, jlong, jdouble, jint, jint, jboolean);

    /*
    * Class:     com_dynarithmic_twain_DTwainJavaAPI
    * Method:    DTWAIN_SetAcquireArea2
 * Signature: (JLcom/dynarithmic/twain/highlevel/TwainAcquireArea;I)I
    */
 ...
 * Signature: (J)Lcom/dynarithmic/twain/highlevel/TwainAcquireArea;
    */
...
JNIEXPORT jint JNICALL Java_com_dynarithmic_twain_DTwainJavaAPI_DTWAIN_1CallDSMProc__Lcom_dynarithmic_twain_lowlevel_TW_1IDENTITY_2Lcom_dynarithmic_twain_lowlevel_TW_1IDENTITY_2JIILjava_lang_Object_2
    (JNIEnv *, jobject, jobject, jobject, jlong, jint, jint, jobject);
...
JNIEXPORT jlong JNICALL Java_com_dynarithmic_twain_DTwainJavaAPI_DTWAIN_1SelectSource2Ex
  (JNIEnv *, jobject, jstring, jint, jint, jstring, jstring, jstring, jint);
