...
1. <a href="https://github.com/dynarithmic/twain_library/tree/master#how-do-i-get-set-up-using-dtwain" target="_blank">Version 5.8.2 of the DTWAIN library</a>.  (For this release of the Java interface, you should be using [this release version](https://github.com/dynarithmic/twain_library/tree/v5.8.2) of the DTWAIN library).
