...
1. <a href="https://github.com/dynarithmic/twain_library/tree/master#how-do-i-get-set-up-using-dtwain" target="_blank">Version 5.7.2 of the DTWAIN library</a>.  (For this release of the Java interface, you should be using [this release version](https://github.com/dynarithmic/twain_library/tree/v5.7.2-Update-1) of the DTWAIN library).
...
5. <a href="https://github.com/dynarithmic/twain_library-java/tree/master/external_jars" target="_blank">The dtwain-java-1.9.3.jar file and miscellaneous third-party libraries</a> must be incorporated into your Java project.  (Note that you must be familiar with adding third-party libraries to your Java project/application within your development environment).
