...
public class TwainAcquisitionArrayEx
{
    private List<TwainAcquisitionDataEx> m_arrAcquisitions = new ArrayList<>();
    private int status;
     ...
     */
    public TwainAcquisitionArrayEx(List<TwainAcquisitionDataEx> allAcquisitions)
    {
        m_arrAcquisitions = allAcquisitions;
    }

    public List<TwainAcquisitionDataEx> getAcquisitonArray()
    {
        return m_arrAcquisitions;
    }

    public TwainAcquisitionArrayEx()
    {
        m_arrAcquisitions = new ArrayList<>();
        status = 0;
    }

    public void setAcquisitionArray(List<TwainAcquisitionDataEx> allPages)
    {
        m_arrAcquisitions = allPages;
        status = 0;
    }

    public void addAcquisitionData(TwainAcquisitionDataEx theData)
    {
    ...
    public TwainAcquisitionDataEx get(int nWhichAcq)
    {
